...
test('Assert manager can choose currencies for account', async ({ page }) => {
  ...
  */
  ...
  await openAccountPage.assertSelectedCurrency(currencies[0]);
  await openAccountPage.assertSelectedCurrency(currencies[1]);
  await openAccountPage.assertSelectedCurrency(currencies[2]);
});
